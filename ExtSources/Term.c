...
// Andrew McKewan -- March 1994
// 07-18-95 SMuB fixed window resizing.

// $Id: term.c 1.1 1994/04/01 07:51:38 andrew Exp $
...
int maxcols = 128;          // number of columns in the screen save buffer
...
// set the forground and background colors for the console
...
void vertscroll (long wParam, long lParam)      // handle vertical scroll bar
{
...
//    theKey = RegGetKey ();
//    RegQueryValueEx (theKey, "Console", NULL, &ktype, s, &slen); 
//    RegCloseKey (theKey);
//    sscanf(s, "%d,%d,%d,%d", &pos.left, &pos.top, &pos.right, &pos.bottom);
//    if (pos.bottom == 0)        // if they have never been set, use defaults
//    {
//        pos.left    = 3;
//        pos.top     = 3;
//        pos.right   = 634;
...
// RO //////////////////////////////////////////////////////////////////////////
    ...
    if (RegQueryValueEx (theKey, "Console", NULL, &ktype, s, &slen))
    {       // if they have never been set, use defaults
        pos.left    = 3;
        pos.top     = 3;
        pos.right   = 634;
        pos.bottom  = 474;
...
ENTRY orientation (int landscape)
{
    ...
    bFlag = OpenPrinter(pdm->dmDeviceName, &hPrinter, &pdef);
